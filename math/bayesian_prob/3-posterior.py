...
def marginal(x, n, P, Pr):
    ...
    Marginal Probability = sum over all probabilities p in P of:
                           [Likelihood(x|n, p) * Prior(p)]
...
def posterior(x, n, P, Pr):
    ...
    P : numpy.ndarray
        ...
        severe side effects.
    Pr : numpy.ndarray
        A 1D array of the prior beliefs about P, with the same shape as P.
    ...
    posterior_vals = intersection / marginal
