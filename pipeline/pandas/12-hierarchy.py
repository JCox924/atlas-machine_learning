...
- Rearranges the MultiIndex so that 'Timestamp' is the first
    level and the service key is the second.
- Returns the concatenated DataFrame sorted in
...
def hierarchy(df1, df2):
    ...
    df2 : Bitstamp data containing a 'Timestamp' column.
