...
class NeuralNetwork:
    ...
    def gradient_descent(self, X, Y, A1, A2, alpha=0.05):
        ...
        X: numpy.ndarray of shape (nx, m) containing the input data
        Y: numpy.ndarray of shape (1, m) containing the correct labels
        A1: numpy.ndarray of shape (nodes, m) containing
         the hidden layer's activated output
        A2: numpy.ndarray of shape (1, m) containing
         the output layer's activated output
        alpha: learning rate
        """
        m = Y.shape[1]
