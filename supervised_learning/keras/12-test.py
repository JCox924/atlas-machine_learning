...
def test_model(network, data, labels, verbose=True):
    ...
    Args:
        ...
        data: A numpy.ndarray of shape (m, nx) containing the input data to test the model with.
        labels: A one-hot numpy.ndarray of shape (m, classes) containing the correct labels of data.
